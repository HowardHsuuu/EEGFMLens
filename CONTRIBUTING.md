...
Run `python -m pip install -e '.[dev,aperiodic]'` and
`pytest -m optional` when changing periodic/aperiodic fitting.
...
```bash
python -m pip install /path/to/eegfmlens-0.1.0a18-py3-none-any.whl pytest
