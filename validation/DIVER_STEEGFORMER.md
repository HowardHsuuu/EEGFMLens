...
```bash
PYTHONPATH=eeglens/src MPLCONFIGDIR=research/eeglens_build_evidence/mpl-cache research/eeglens_model_validation/.venv-braindecode/bin/python eeglens/validation/validate_diver_steegformer.py --model diver
PYTHONPATH=eeglens/src MPLCONFIGDIR=research/eeglens_build_evidence/mpl-cache research/eeglens_model_validation/.venv-braindecode/bin/python eeglens/validation/validate_diver_steegformer.py --model steegformer
```
