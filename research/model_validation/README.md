...
```bash
python research/model_validation/validate.py --root /absolute/path/to/external-root --model eegpt --output /absolute/path/to/results
python research/model_validation/validate.py --root /absolute/path/to/external-root --model biot --output /absolute/path/to/results
python research/model_validation/validate.py --root /absolute/path/to/external-root --model biot-prest --output /absolute/path/to/results
python research/model_validation/validate.py --root /absolute/path/to/external-root --model bendr --output /absolute/path/to/results
```
...
```bash
MPLCONFIGDIR=research/eeglens_build_evidence/mpl-cache research/eeglens_survey_2026-09-09/.venv/bin/python eeglens/research/model_validation/validate_signaljepa.py --direct-source research/eeglens_survey_2026-09-09/.venv/lib/python3.12/site-packages/braindecode
```
...
```bash
MPLCONFIGDIR=research/eeglens_build_evidence/mpl-cache research/eeglens_survey_2026-09-09/.venv/bin/python eeglens/research/model_validation/validate_bendr_context.py
PYTHONPATH=eeglens/src MPLCONFIGDIR=research/eeglens_build_evidence/mpl-cache research/eeglens_model_validation/.venv-braindecode/bin/python eeglens/research/model_validation/validate_signaljepa.py
```
