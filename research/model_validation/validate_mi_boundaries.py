...
sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "mi"))
from extract import CHANNELS, build, sha
...
def run(name):
    ...
    out = Path("eeglens/research/model_validation/results/input-boundaries-v1")
